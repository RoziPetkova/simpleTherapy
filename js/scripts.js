...
$(window).scroll(function() {
    let kur = `linear-gradient(to bottom, rgba(0,0,0,0) 0%,rgb(36, 30, 30, ${$(window).scrollTop() / 750}) ${120 - $(window).scrollTop() / 7}%)`;
    $(".containerFade").css("background", kur);
...
function loadStatii(statii) {
    ...
    for (let statiq of lastSixPapers) {
        $("#portfolio .container .row").append(getArticlesContainer(statiq.imgLink, statiq.title, statiq.subtitle, statiq.id));
        $("#page-top").append(getPopupContainer(statiq.id, statiq.title, statiq.subtitle, statiq.imgLink, statiq.content, statiq.date, statiq.author));
    }
};
...
//                     </a> 
//                     <div class="portfolio-caption"> 
//                         <div class="portfolio-caption-heading">${statiqTitle}</div> 
//                         <div class="portfolio-caption-subheading text-muted">${statiqSubtitle}</div> 
//                     </div>
//                 </div>
//             </div>`;
// };

// function ShowAdditionalSection(currentSectionId){
